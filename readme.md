...
Internal V-speed calculator will broke (actually, it is broken since the beginning). Please refer to proper A330 Manual or these speed tables
...
(or even fake 'three tank' variant, if MCDU Block fuel limit doesn't exist.- it doesn't :D)
